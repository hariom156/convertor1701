...
<body>
    ...
    <script>
        document.getElementById('fromUnit').value = window.fromUnt;
        document.getElementById('toUnit').value = window.toUnt;
        document.getElementById('from-lbl').innerHTML = window.fromUnt;
        document.getElementById('to-lbl').innerHTML = window.toUnt;
    </script>
    <script src="data/lengthFormula.js"></script>
